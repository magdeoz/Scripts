...
TOOLS(){
        sudo apt-get -y install git-core python gnupg \
                flex bison gperf libsdl1.2-dev libesd0-dev \
                libwxgtk2.8-dev squashfs-tools build-essential \
                zip curl libncurses5-dev zlib1g-dev pngcrush \
                schedtool libxml2 libxml2-utils xsltproc lzop \
                libc6-dev schedtool g++-multilib lib32z1-dev \
                lib32ncurses5-dev gcc-multilib liblz4-* pngquant \
                ncurses-dev texinfo gcc gperf patch libtool \
                automake g++ gawk subversion expat libexpat1-dev \
                python-all-dev binutils-static bc libcloog-isl-dev \
                libcap-dev autoconf libgmp-dev build-essential \
                gcc-multilib g++-multilib pkg-config libmpc-dev libmpfr-dev lzma* \
